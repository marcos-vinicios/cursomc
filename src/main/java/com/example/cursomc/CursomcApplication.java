...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Produto p10 = new Produto(null, "Abajour", 180.00);
		Produto p11 = new Produto(null, "Shampoo", 90.00);
		
		cat1.getProdutos().addAll(Arrays.asList(p1,p2,p3));//associando os produtos
		...
		Cliente cli1 = new Cliente(null,"Maria silva","maria@gmail.com","3333565698", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("313522930","99987831432"));
		
		Endereco e1 = new Endereco(null, "Rua flores","300","Apto 303","Jardim","325658868",cli1,c1);
		Endereco e2 = new Endereco(null, "Avenida Matos","105", "sala 800", "centro", "32326565",cli1,c2);
		...
		Pedido pd1 = new Pedido(null,sdf.parse("31/03/2021 20:57"),cli1,e1);
		Pedido pd2 = new Pedido(null,sdf.parse("31/03/2021 22:57"),cli1,e2);
		
		Pagamento pagto1 = new PagamentoComCartao(null, EstadoPagamento.QUITADO, pd1,6);
		pd1.setPagamento(pagto1);
		
		Pagamento pagto2 = new PagamentoComBoleto(null, EstadoPagamento.PENDENTE, pd2,sdf.parse("31/03/2021 21:00"),null);
